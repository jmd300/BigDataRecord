...
public final class RPCDateServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.zoo.grpc.api.RPCDateService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.zoo.grpc.api.RPCDateRequest,
      com.zoo.grpc.api.RPCDateResponse> getGetDateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getDate",
      requestType = com.zoo.grpc.api.RPCDateRequest.class,
      responseType = com.zoo.grpc.api.RPCDateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.zoo.grpc.api.RPCDateRequest,
      com.zoo.grpc.api.RPCDateResponse> getGetDateMethod() {
    io.grpc.MethodDescriptor<com.zoo.grpc.api.RPCDateRequest, com.zoo.grpc.api.RPCDateResponse> getGetDateMethod;
      ...
      synchronized (RPCDateServiceGrpc.class) {
        if ((getGetDateMethod = RPCDateServiceGrpc.getGetDateMethod) == null) {
          RPCDateServiceGrpc.getGetDateMethod = getGetDateMethod =
              io.grpc.MethodDescriptor.<com.zoo.grpc.api.RPCDateRequest, com.zoo.grpc.api.RPCDateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getDate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zoo.grpc.api.RPCDateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zoo.grpc.api.RPCDateResponse.getDefaultInstance()))
  ...
  public static abstract class RPCDateServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getDate(com.zoo.grpc.api.RPCDateRequest request,
        io.grpc.stub.StreamObserver<com.zoo.grpc.api.RPCDateResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.zoo.grpc.api.RPCDateRequest,
                com.zoo.grpc.api.RPCDateResponse>(
  ...
  public static final class RPCDateServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<RPCDateServiceBlockingStub> {
    ...
    /**
     */
    public com.zoo.grpc.api.RPCDateResponse getDate(com.zoo.grpc.api.RPCDateRequest request) {
  ...
  public static final class RPCDateServiceFutureStub extends io.grpc.stub.AbstractFutureStub<RPCDateServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.zoo.grpc.api.RPCDateResponse> getDate(
        com.zoo.grpc.api.RPCDateRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DATE:
          serviceImpl.getDate((com.zoo.grpc.api.RPCDateRequest) request,
              (io.grpc.stub.StreamObserver<com.zoo.grpc.api.RPCDateResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class RPCDateServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.zoo.grpc.api.RPCDateServiceApi.getDescriptor();
    }
