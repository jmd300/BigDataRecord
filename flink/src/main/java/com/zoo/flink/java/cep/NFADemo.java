...
import com.zoo.flink.java.util.LoginEvent;
 ...
 * @Date: 6/20/2023
 *
 * 使用状态值和状态机机制，实现CEP的简单模式，即三次登录失败的匹配机制。
 */
public class NFADemo extends FlinkEnv {
    ...
    public enum State {
        ...
        Matched, // 匹配成功
        // S2 状态, 输入fail，转移到Match 或者 输入success 转移到Terminal
